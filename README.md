...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #141** / tag `build-141` / source commit `29cddf6` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29562781953`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-141` |
| APK | `WearHealthCompanion-mobile-v1.0.141-code141.apk`；`WearHealthCompanion-watch-v1.0.141-code141-ecg.apk` |
| 更新时间 | 2026-07-17T07:25:47Z |
