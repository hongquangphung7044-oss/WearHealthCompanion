...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #140** / tag `build-140` / source commit `585f58c` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29559469828`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-140` |
| APK | `WearHealthCompanion-mobile-v1.0.140-code140.apk`；`WearHealthCompanion-watch-v1.0.140-code140-ecg.apk` |
| 更新时间 | 2026-07-17T06:19:18Z |
