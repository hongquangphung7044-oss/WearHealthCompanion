...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #64** / tag `build-64` / source commit `f033b4c` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29398940803`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-64` |
| APK | `WearHealthCompanion-mobile-v1.0.64-code64.apk`；`WearHealthCompanion-watch-v1.0.64-code64-ecg.apk` |
| 更新时间 | 2026-07-15T08:02:21Z |
