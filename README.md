...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #108** / tag `build-108` / source commit `8faf802` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29474380385`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-108` |
| APK | `WearHealthCompanion-mobile-v1.0.108-code108.apk`；`WearHealthCompanion-watch-v1.0.108-code108-ecg.apk` |
| 更新时间 | 2026-07-16T05:44:50Z |
