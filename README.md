...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #109** / tag `build-109` / source commit `3630c76` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29474789929`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-109` |
| APK | `WearHealthCompanion-mobile-v1.0.109-code109.apk`；`WearHealthCompanion-watch-v1.0.109-code109-ecg.apk` |
| 更新时间 | 2026-07-16T05:54:32Z |
