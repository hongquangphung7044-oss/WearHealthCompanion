...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #113** / tag `build-113` / source commit `10a18b2` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29477351884`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-113` |
| APK | `WearHealthCompanion-mobile-v1.0.113-code113.apk`；`WearHealthCompanion-watch-v1.0.113-code113-ecg.apk` |
| 更新时间 | 2026-07-16T06:47:41Z |
