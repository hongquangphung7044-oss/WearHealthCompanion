...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #81** / tag `build-81` / source commit `14f0d05` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29422459676`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-81` |
| APK | `WearHealthCompanion-mobile-v1.0.81-code81.apk`；`WearHealthCompanion-watch-v1.0.81-code81-ecg.apk` |
| 更新时间 | 2026-07-15T14:22:36Z |
