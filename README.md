...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #106** / tag `build-106` / source commit `cc8e571` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29473297689`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-106` |
| APK | `WearHealthCompanion-mobile-v1.0.106-code106.apk`；`WearHealthCompanion-watch-v1.0.106-code106-ecg.apk` |
| 更新时间 | 2026-07-16T05:22:37Z |
