...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #103** / tag `build-103` / source commit `6572242` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29471037880`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-103` |
| APK | `WearHealthCompanion-mobile-v1.0.103-code103.apk`；`WearHealthCompanion-watch-v1.0.103-code103-ecg.apk` |
| 更新时间 | 2026-07-16T04:26:39Z |
