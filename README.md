...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #67** / tag `build-67` / source commit `1f3bcd2` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29406276056`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-67` |
| APK | `WearHealthCompanion-mobile-v1.0.67-code67.apk`；`WearHealthCompanion-watch-v1.0.67-code67-ecg.apk` |
| 更新时间 | 2026-07-15T10:03:04Z |
