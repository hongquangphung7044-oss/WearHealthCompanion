...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #120** / tag `build-120` / source commit `a70f649` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29486425971`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-120` |
| APK | `WearHealthCompanion-mobile-v1.0.120-code120.apk`；`WearHealthCompanion-watch-v1.0.120-code120-ecg.apk` |
| 更新时间 | 2026-07-16T09:23:36Z |
