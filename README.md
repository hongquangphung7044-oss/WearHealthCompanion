...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #85** / tag `build-85` / source commit `6c29b2f` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29427623557`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-85` |
| APK | `WearHealthCompanion-mobile-v1.0.85-code85.apk`；`WearHealthCompanion-watch-v1.0.85-code85-ecg.apk` |
| 更新时间 | 2026-07-15T15:28:34Z |
