...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #100** / tag `build-100` / source commit `4bc7ea0` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29466908483`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-100` |
| APK | `WearHealthCompanion-mobile-v1.0.100-code100.apk`；`WearHealthCompanion-watch-v1.0.100-code100-ecg.apk` |
| 更新时间 | 2026-07-16T02:42:54Z |
