...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #78** / tag `build-78` / source commit `f598fb2` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29418423015`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-78` |
| APK | `WearHealthCompanion-mobile-v1.0.78-code78.apk`；`WearHealthCompanion-watch-v1.0.78-code78-ecg.apk` |
| 更新时间 | 2026-07-15T13:23:22Z |
