...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #86** / tag `build-86` / source commit `12a42c5` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29428851502`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-86` |
| APK | `WearHealthCompanion-mobile-v1.0.86-code86.apk`；`WearHealthCompanion-watch-v1.0.86-code86-ecg.apk` |
| 更新时间 | 2026-07-15T15:43:10Z |
