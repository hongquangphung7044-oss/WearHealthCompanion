...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #97** / tag `build-97` / source commit `697ccc7` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29464968502`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-97` |
| APK | `WearHealthCompanion-mobile-v1.0.97-code97.apk`；`WearHealthCompanion-watch-v1.0.97-code97-ecg.apk` |
| 更新时间 | 2026-07-16T01:55:22Z |
