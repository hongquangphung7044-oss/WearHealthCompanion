...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #101** / tag `build-101` / source commit `1246629` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29468136342`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-101` |
| APK | `WearHealthCompanion-mobile-v1.0.101-code101.apk`；`WearHealthCompanion-watch-v1.0.101-code101-ecg.apk` |
| 更新时间 | 2026-07-16T03:13:44Z |
