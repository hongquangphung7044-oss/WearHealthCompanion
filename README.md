...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #126** / tag `build-126` / source commit `56e0a5a` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29492984274`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-126` |
| APK | `WearHealthCompanion-mobile-v1.0.126-code126.apk`；`WearHealthCompanion-watch-v1.0.126-code126-ecg.apk` |
| 更新时间 | 2026-07-16T11:10:35Z |
