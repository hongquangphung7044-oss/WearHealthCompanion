...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #91** / tag `build-91` / source commit `4ba66db` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29460571159`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-91` |
| APK | `WearHealthCompanion-mobile-v1.0.91-code91.apk`；`WearHealthCompanion-watch-v1.0.91-code91-ecg.apk` |
| 更新时间 | 2026-07-16T00:15:25Z |
