...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #93** / tag `build-93` / source commit `1c33449` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29461870502`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-93` |
| APK | `WearHealthCompanion-mobile-v1.0.93-code93.apk`；`WearHealthCompanion-watch-v1.0.93-code93-ecg.apk` |
| 更新时间 | 2026-07-16T00:43:55Z |
