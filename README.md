...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #155** / tag `build-155` / source commit `acc0adc` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/30202500995`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-155` |
| APK | `WearHealthCompanion-mobile-v1.0.155-code155.apk`；`WearHealthCompanion-watch-v1.0.155-code155-ecg.apk` |
| 更新时间 | 2026-07-26T12:44:42Z |
