...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #76** / tag `build-76` / source commit `8095f9f` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29414748747`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-76` |
| APK | `WearHealthCompanion-mobile-v1.0.76-code76.apk`；`WearHealthCompanion-watch-v1.0.76-code76-ecg.apk` |
| 更新时间 | 2026-07-15T12:27:15Z |
