...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #92** / tag `build-92` / source commit `c76e971` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29461110091`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-92` |
| APK | `WearHealthCompanion-mobile-v1.0.92-code92.apk`；`WearHealthCompanion-watch-v1.0.92-code92-ecg.apk` |
| 更新时间 | 2026-07-16T00:25:24Z |
