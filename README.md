...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #66** / tag `build-66` / source commit `41f0fc0` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29403300700`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-66` |
| APK | `WearHealthCompanion-mobile-v1.0.66-code66.apk`；`WearHealthCompanion-watch-v1.0.66-code66-ecg.apk` |
| 更新时间 | 2026-07-15T09:13:13Z |
