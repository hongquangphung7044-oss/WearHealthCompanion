...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #71** / tag `build-71` / source commit `5360371` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29409620503`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-71` |
| APK | `WearHealthCompanion-mobile-v1.0.71-code71.apk`；`WearHealthCompanion-watch-v1.0.71-code71-ecg.apk` |
| 更新时间 | 2026-07-15T10:59:33Z |
