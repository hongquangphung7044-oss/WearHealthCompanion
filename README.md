...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #123** / tag `build-123` / source commit `3a97c06` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29491317589`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-123` |
| APK | `WearHealthCompanion-mobile-v1.0.123-code123.apk`；`WearHealthCompanion-watch-v1.0.123-code123-ecg.apk` |
| 更新时间 | 2026-07-16T10:42:27Z |
