...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #69** / tag `build-69` / source commit `b7ae47a` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29407911245`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-69` |
| APK | `WearHealthCompanion-mobile-v1.0.69-code69.apk`；`WearHealthCompanion-watch-v1.0.69-code69-ecg.apk` |
| 更新时间 | 2026-07-15T10:31:08Z |
