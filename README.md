...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #79** / tag `build-79` / source commit `863d897` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29420349402`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-79` |
| APK | `WearHealthCompanion-mobile-v1.0.79-code79.apk`；`WearHealthCompanion-watch-v1.0.79-code79-ecg.apk` |
| 更新时间 | 2026-07-15T13:50:58Z |
