...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #107** / tag `build-107` / source commit `b004c1f` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29473602370`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-107` |
| APK | `WearHealthCompanion-mobile-v1.0.107-code107.apk`；`WearHealthCompanion-watch-v1.0.107-code107-ecg.apk` |
| 更新时间 | 2026-07-16T05:31:10Z |
