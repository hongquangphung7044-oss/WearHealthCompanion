...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #89** / tag `build-89` / source commit `7c44e57` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29431736712`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-89` |
| APK | `WearHealthCompanion-mobile-v1.0.89-code89.apk`；`WearHealthCompanion-watch-v1.0.89-code89-ecg.apk` |
| 更新时间 | 2026-07-15T16:25:25Z |
