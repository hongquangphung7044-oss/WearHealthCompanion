...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #98** / tag `build-98` / source commit `7b78f59` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29466045631`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-98` |
| APK | `WearHealthCompanion-mobile-v1.0.98-code98.apk`；`WearHealthCompanion-watch-v1.0.98-code98-ecg.apk` |
| 更新时间 | 2026-07-16T02:21:11Z |
