...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #82** / tag `build-82` / source commit `eb8dbfe` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29424951999`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-82` |
| APK | `WearHealthCompanion-mobile-v1.0.82-code82.apk`；`WearHealthCompanion-watch-v1.0.82-code82-ecg.apk` |
| 更新时间 | 2026-07-15T14:51:21Z |
