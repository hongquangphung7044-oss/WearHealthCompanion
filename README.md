...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #104** / tag `build-104` / source commit `af30195` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29471975799`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-104` |
| APK | `WearHealthCompanion-mobile-v1.0.104-code104.apk`；`WearHealthCompanion-watch-v1.0.104-code104-ecg.apk` |
| 更新时间 | 2026-07-16T04:49:24Z |
