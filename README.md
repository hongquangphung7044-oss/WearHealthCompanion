...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #58** / tag `build-58` / source commit `12f9326` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29312534825`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-58` |
| APK | `WearHealthCompanion-mobile-v1.0.58-code58.apk`；`WearHealthCompanion-watch-v1.0.58-code58-ecg.apk` |
| 更新时间 | 2026-07-14T06:57:08Z |
