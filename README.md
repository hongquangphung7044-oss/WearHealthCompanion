...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #80** / tag `build-80` / source commit `3c01aff` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29422043823`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-80` |
| APK | `WearHealthCompanion-mobile-v1.0.80-code80.apk`；`WearHealthCompanion-watch-v1.0.80-code80-ecg.apk` |
| 更新时间 | 2026-07-15T14:14:16Z |
