...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #118** / tag `build-118` / source commit `d9325b0` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29483472014`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-118` |
| APK | `WearHealthCompanion-mobile-v1.0.118-code118.apk`；`WearHealthCompanion-watch-v1.0.118-code118-ecg.apk` |
| 更新时间 | 2026-07-16T08:35:02Z |
