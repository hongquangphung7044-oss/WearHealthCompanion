...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #102** / tag `build-102` / source commit `9da2ca2` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29468308493`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-102` |
| APK | `WearHealthCompanion-mobile-v1.0.102-code102.apk`；`WearHealthCompanion-watch-v1.0.102-code102-ecg.apk` |
| 更新时间 | 2026-07-16T03:22:04Z |
