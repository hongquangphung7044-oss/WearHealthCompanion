...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #136** / tag `build-136` / source commit `fd37011` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29548021317`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-136` |
| APK | `WearHealthCompanion-mobile-v1.0.136-code136.apk`；`WearHealthCompanion-watch-v1.0.136-code136-ecg.apk` |
| 更新时间 | 2026-07-17T01:47:04Z |
