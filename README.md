...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #99** / tag `build-99` / source commit `43372f6` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29466244167`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-99` |
| APK | `WearHealthCompanion-mobile-v1.0.99-code99.apk`；`WearHealthCompanion-watch-v1.0.99-code99-ecg.apk` |
| 更新时间 | 2026-07-16T02:28:59Z |
