...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #151** / tag `build-151` / source commit `85f6442` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29647685464`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-151` |
| APK | `WearHealthCompanion-mobile-v1.0.151-code151.apk`；`WearHealthCompanion-watch-v1.0.151-code151-ecg.apk` |
| 更新时间 | 2026-07-18T14:20:31Z |
