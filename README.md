...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #135** / tag `build-135` / source commit `682cc6c` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29547458314`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-135` |
| APK | `WearHealthCompanion-mobile-v1.0.135-code135.apk`；`WearHealthCompanion-watch-v1.0.135-code135-ecg.apk` |
| 更新时间 | 2026-07-17T01:35:14Z |
