...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #60** / tag `build-60` / source commit `f989d6d` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29317918539`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-60` |
| APK | `WearHealthCompanion-mobile-v1.0.60-code60.apk`；`WearHealthCompanion-watch-v1.0.60-code60-ecg.apk` |
| 更新时间 | 2026-07-14T08:32:40Z |
