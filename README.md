...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #75** / tag `build-75` / source commit `3389e73` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29412607303`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-75` |
| APK | `WearHealthCompanion-mobile-v1.0.75-code75.apk`；`WearHealthCompanion-watch-v1.0.75-code75-ecg.apk` |
| 更新时间 | 2026-07-15T11:49:31Z |
