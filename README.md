...
| 自动发布项目 | 最新成功状态 |
|---|---|
| CI 构建 | **Build #88** / tag `build-88` / source commit `05073a2` |
| Actions | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/actions/runs/29430812321`（协议测试、双 Release APK、Artifact、Release 全部成功） |
| Release | `https://github.com/hongquangphung7044-oss/WearHealthCompanion/releases/tag/build-88` |
| APK | `WearHealthCompanion-mobile-v1.0.88-code88.apk`；`WearHealthCompanion-watch-v1.0.88-code88-ecg.apk` |
| 更新时间 | 2026-07-15T16:11:54Z |
